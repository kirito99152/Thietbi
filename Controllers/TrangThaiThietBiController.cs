...
{
    public class TrangThaiThietBiController : Controller
    {
        private readonly ThietBiContext _context;

        public TrangThaiThietBiController(ThietBiContext context)
        {
            _context = context;
        }

        // GET: TrangThaiThietBi
        public async Task<IActionResult> Index()
        {
            return View(await _context.DmTrangThaiThietBis.ToListAsync());
        }

        // GET: TrangThaiThietBi/Details/5
        ...
        // GET: TrangThaiThietBi/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TrangThaiThietBi/Create
        ...
        // POST: TrangThaiThietBi/Delete/5
